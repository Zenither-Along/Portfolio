    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-2 text-left">
        ...
        >
          ...
          <svg 
            ...
            className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform -rotate-45"
          >
            <path d="M5 12h14" />
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-2 text-left">
        ...
        <div className="flex items-center gap-4 justify-start">
          <a 
            href="https://github.com/alongbar" 
            target="_blank" 
          ...
          <a 
            href="https://linkedin.com/in/alongbar" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-white hover:text-gray-300 transition-colors"
            aria-label="LinkedIn"
          ...
          <a 
            href="https://twitter.com/alongbar" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-white hover:text-gray-300 transition-colors"
            aria-label="Twitter"
          ...
          <a 
            href="https://instagram.com/alongbar" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-white hover:text-gray-300 transition-colors"
