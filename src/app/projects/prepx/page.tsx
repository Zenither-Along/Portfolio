...
const projectData = {
  ...
  subtitle: "AI-Powered Learning Path Platform",
  description:
    "PrepX is an intelligent learning platform that transforms how educators teach and students learn. It enables users to create structured, hierarchical learning paths with AI-powered content generation, smart quizzes, and collaborative classroom features. With Google Gemini integration, users can generate complete learning paths from text, PDFs, or topics, making education more accessible and personalized.",
  image: "/1project.png",
  year: "2025",
  role: "Full-Stack Developer & UI Designer",
  duration: "1 month",
  features: [
    "Create structured, hierarchical learning paths with branches and items",
    "AI Path Generator - Generate complete paths from text, PDFs, or topics using Google Gemini",
    "AI Content Editor - Get assistance to generate content sections and branches",
    "AI Chat Assistant - Ask questions with context-aware responses",
    "Rich Text Editor with headings, lists, code blocks, and more",
    "Smart Quizzes - Generate AI-powered quizzes from learning content",
    "Virtual Classrooms for educators to manage students",
    "Assignments with due dates and progress tracking",
  ...
  liveUrl: "https://prep-x-along.vercel.app/",
  githubUrl: "https://github.com/Zenither-Along/PrepX-new",
};

export default function PrepXProjectPage() {
  return (
    <>
      <ProfileBar />
      <main 
